...
echo --  Starting a Hosted Network called: AndroidDev1
netsh wlan set hostednetwork mode=allow SSID=AndroidDev1 key=RobotsRule
...
adb tcpip 5555
echo --
echo --  Now connect your phone to the "AndroidDev1" network.
